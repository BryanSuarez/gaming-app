...
<body class="bg-gray-900 text-white">
            ...
            <div class="flex items-center">
                <div class="relative">
                    ...
                    <div class="absolute top-0 flex items-center h-full ml-3">
                        <svg viewBox="0 0 20 20" fill="currentColor" class=" fill-current text-gray-400 search w-4">
                            <defs />
    ...
    <footer class="border-t border-gray-800">
        <div class="container mx-auto px-4 py-6">
            Desarrollado por <a href="#" class="underline hover:text-gray-400">Bryan Suárez</a>
        </div>
    </footer>
</body>
